...
{
    class ValidatorSingleLong: IValidatorSingleFieldLong
    {
        private IRuleConfiguration RulesConfig;

        private List<IRuleDetail> RuleDetails;

        List<FieldInfoLong> FieldInfoList = new List<FieldInfoLong>();
        ...
        public List<IValidationMessage> Validate()
        {
            ...
            FieldInfoList.ForEach(delegate (FieldInfoLong aFieldInfo)
            {
        ...
        private static List<IValidationMessage> GreaterThan(FieldInfoLong aFieldInfo, int greaterThanValue, IRuleDetail aRuleDetail) {
        ...
        private static List<IValidationMessage> LessThan(FieldInfoLong aFieldInfo, int lessThanValue, IRuleDetail aRuleDetail)
        {
